...
public class WavefrontParser {
    ...
    public static List<Vec4> vertices = new ArrayList<Vec4>();
    public static List<Vec4> normals = new ArrayList<Vec4>();
    public static List<Vec2> textures = new ArrayList<Vec2>();
