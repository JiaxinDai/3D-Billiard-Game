...
import billiard.physics2d.ContactListener;
import billiard.physics2d.Physics2D;
import billiard.physics2d.RigidBody;
import billiard.physics2d.StaticLine;
 ...
 * 
 */
public class BilliardGameModel implements ContactListener {
    
    public static enum Mode { _1UP_2UP, _1UP_CPU };
    public static enum State {
        NONE, BREAK, OPEN, TURN, WIN_1UP, WIN_2UP
    };
    protected final List<BilliardModelListener> listeners = new ArrayList<BilliardModelListener>();
    ...
    public void addModelListener(BilliardModelListener listener) {
    ...
    public void setState(State state) {
        if (this.state != state) {
            this.state = state;
            for (BilliardModelListener listener : listeners) {
