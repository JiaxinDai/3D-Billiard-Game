...
import static billiard.model.BilliardGameModel.MAX_IMPULSE_LENGTH;

import java.awt.Color;
import java.awt.Font;
import java.awt.Graphics2D;

import billiard.game.BallIconDrawer;
 ...
 * 
 */
public class HUD extends BilliardEntity {
    ...
    public HUD(String name, BilliardScene scene) {
        super(name, scene);
    }
