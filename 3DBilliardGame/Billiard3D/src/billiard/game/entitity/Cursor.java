...
import billiard.math.Line;
import billiard.math.Plane;
...
import billiard.physics2d.Physics2DTime;
import billiard.physics2d.Vec2;
 ...
 * 
 */
public class Cursor extends BilliardEntity {
    ...
    public Cursor(String name, BilliardScene scene, Camera camera) {
        super(name, scene);
        this.camera = camera;
        setVisible(true);
    }
        ...
        while (true) {
            switch (instructionPointer) {
                ...
                case 11:
                    ...
                    if (gameModel.getImpulseLength() > BilliardGameModel.MAX_IMPULSE_LENGTH) {
                        gameModel.setImpulseLength(BilliardGameModel.MAX_IMPULSE_LENGTH);
    ...
    public void preDraw(Renderer renderer) {
        ...
        renderer.setShader(BilliardScene.cursorShader);
    ...
    public void draw(Renderer renderer) {
        if (scene.getState() == BilliardScene.State.PLAYING_2 
    ...
    public void stateChanged() {
        setVisible(scene.getState() == BilliardScene.State.PLAYING_1
